...
Last README file update: Mon Aug 17 22:18:07 UTC 2026
...
command.autoleveling
command.autoleveling.level
command.autoleveling.level.add
command.autoleveling.level.add.value
command.back
command.backup
...
command.gamerule
command.gamerule.allowFlamebreathersSpawning
command.gamerule.allowFlamebreathersSpawning.value
command.gamerule.allowGraverisers
command.gamerule.allowGraverisers.value
...
command.gamerule.buildingDebug
command.gamerule.buildingDebug.value
...
command.gamerule.fragileBlocks
command.gamerule.fragileBlocks.value
